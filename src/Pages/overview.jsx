        ...
        <>
            ...
            <div className="flex flex-col items-center gap-3 pt-5">
                ...
                <div className="space-x-4 text-lg text-black  ">
                    ...
                    <a href="#plans" className="bg-amber-50 rounded-2xl px-2 py-1">Voir la répartition des plans</a>
                </div>
            </div>
            ...
            <div className="md:flex md:justify-around px-5 flex flex-col items-center gap-10 min-h-[400px] py-30" id="plans">
                <h2 className="text-2xl font-bold text-center py-6 text-white">Répartition des plans</h2>
                <ChartCam />
            </div>
        </>
    )
